...
public class SheetsQuickstart {
	 private static final String APPLICATION_NAME = "Google Sheets API Java Quickstart";
	    ...
	    private static final String CREDENTIALS_FILE_PATH = "/client_secret_6.json";
	    ...
	    private static Credential authorize(final NetHttpTransport HTTP_TRANSPORT) throws Exception {
	    	   ...
	    	   GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
	    	       new InputStreamReader(SheetsQuickstart.class.getResourceAsStream(CREDENTIALS_FILE_PATH)));
